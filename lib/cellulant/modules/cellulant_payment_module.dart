...
class CellulantPaymentModule{
  CellulantPaymentModule({this.amount, this.accountNumber, this.serviceID});
  ...
  Future<Map<String, dynamic>> pay()async{
    ...
    final Map<String, dynamic> _payload = {
      ...
      "payload": "{\"credentials\":{\"username\":\"$cellulantUsername\",\"password\":\"$cellulantPassword\"},\"packet\": [{\"MSISDN\":\"254797162465\",\"amount\":\"$amount\",\"serviceID\":$serviceID,\"currencyCode\":\"KES\",\"narration\":\"Paydstv\",\"accountNumber\":\"$accountNumber\",\"extraData\":\"\",\"datePaymentReceived\":\"$dateString\",\"payerTransactionID\":\"$payerTransactionID\",\"customerNames\":\"SimonMathenge\"}]}"
    };
    try {
